...
def about_app():
    with st.sidebar.expander("ℹ️ - Why this GitHub Insights AI"):
        st.sidebar.caption("""GitHub Insights Assistant helps you stay updated with the top trending GitHub repositories in your preferred technology. It summarizes key details like repository features, language, and purpose, and can send a professional email with this information to your inbox, ensuring you never miss out on the latest tools and frameworks.
        """)
